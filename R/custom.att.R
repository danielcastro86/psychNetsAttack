custom.att <- function(g, custom){
  ...
  names(df)<-c( "custom.att.vertex", "custom.att.value","custom.att.number.of.vertices", "custom.att.maxcsize", "custom.att.cohesion", "custom.att.averagepath", "custom.att.adhesion", "custom.att.edgedensity", "custom.att.transitivity", "custom.att.radius", "custom.att.density", "custom.att.centralization", "custom.att.components")
  return(df)
}
