norm.att.bridstr <- function(g, adjmat){
  ...
  }}, movie.name="graph.norm.att.bridstr.gif")
  ...
  names(df)<-c( "norm.att.bridstr.vertex", "norm.att.bridstr.value", "norm.att.bridstr.number.of.vertices", "norm.att.bridstr.maxcsize", "norm.att.bridstr.cohesion", "norm.att.bridstr.averagepath", "norm.att.bridstr.adhesion", "norm.att.bridstr.edgedensity", "norm.att.bridstr.transitivity", "norm.att.bridstr.radius", "norm.att.bridstr.density", "norm.att.bridstr.centralization", "norm.att.bridstr.diameter", "norm.att.bridstr.components")
  return(df)
}
