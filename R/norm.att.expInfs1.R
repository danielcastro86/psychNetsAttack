norm.att.expInfs1 <- function(g){
  ...
  }}, movie.name = "graph.norm.att.ExpInfs1.gif")
  ...
  names(df)<-c( "norm.att.ExpInfs1.vertex", "norm.att.ExpInfs1.value", "norm.att.ExpInfs1.number.of.vertices",  "norm.att.ExpInfs1.maxcsize", "norm.att.ExpInfs1.cohesion", "norm.att.ExpInfs1.averagepath", "norm.att.ExpInfs1.adhesion", "norm.att.ExpInfs1.edgedensity", "norm.att.ExpInfs1.transitivity", "norm.att.ExpInfs1.radius", "norm.att.ExpInfs1.density", "norm.att.ExpInfs1.centralization", "norm.att.ExpInfs1.diameter", "norm.att.ExpInfs1.components")
  return(df)
}
